...
from ptranking.ltr_ntree.ltr_gandalf.eval.ltr_gandalf import GFLULTREvaluator
from ptranking.ltr_global import ltr_seed
from ptranking.ltr_ntree.ltr_tabnet.eval.ltr_ntree import NeuralTreeLTREvaluator
...
if __name__ == '__main__':
    ...
    if config_with_json:  # specify configuration with json files
        ...
        dir_json = '/home/user/Workbench/tan_haonan/test/testing/ltr_ntree/ltr_tabnet/json/'
